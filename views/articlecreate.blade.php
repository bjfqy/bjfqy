  ...
  <h2>文章多功能操作<a href="/article/create"><button type="button" class="btn btn-success">添加文章</button></a>         
		...
		<form method="post"  action="/article" enctype="multipart/form-data">
		    ...
		    <div class="form-group">
		      ...
		      <input name="title" type="text" class="form-control" id="title" placeholder="请输入文章标题">
		   	...
		   	<label for="comment2">文章楔子</label>
      			<textarea class="form-control" rows="2" name="qizi" id="comment2"></textarea>
			</div>

		    <label for="name">文章类目:</label>
		    <select class="form-control" name="artnav">
			...
			<div class="form-group">
			    ...
			    <input type="text" name="tag" class="form-control" placeholder="文本输入 请用空格进行分割 我们会在数据库中提取 短标签 ">
			  </div>
